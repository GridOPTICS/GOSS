package gov.pnnl.goss.security.propertyfile;
 ...
 * started as a component if a gov.pnnl.goss.core.security.properties.cfg file exists
...
public class PropertyBasedRealm extends AuthorizingRealm implements GossRealm {
	...
	private static final String CONFIG_PID = "gov.pnnl.goss.core.security.propertyfile";
