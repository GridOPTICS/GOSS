...
Requires a running GOSS server with STOMP and WebSocket transports enabled.
Configure via environment variables or command-line arguments.

Usage:
    # Activate the virtual environment
    source pnnl.goss.core.itests/.venv/bin/activate

    # Run all tests
    pytest pnnl.goss.core.itests/src/pnnl/goss/core/itests/test_token_auth.py -v
    ...
    python pnnl.goss.core.itests/src/pnnl/goss/core/itests/test_token_auth.py

    # Custom host/ports
    python ... --stomp-host localhost --stomp-port 61618 --ws-port 61616
"""
...
WS_PORT = int(os.environ.get("GOSS_WS_PORT", "61616"))
USERNAME = os.environ.get("GOSS_USERNAME", "craig")
PASSWORD = os.environ.get("GOSS_PASSWORD", "craig")
